...
public struct Base64UnsignedInteger: Hashable {
...
extension Base64UnsignedInteger: RawRepresentable {
...
extension Base64UnsignedInteger: Comparable {
...
extension Base64UnsignedInteger: TextOutputStreamable {
...
extension Base64UnsignedInteger: LosslessStringConvertible {
  ...
  public static func decode<S: StringProtocol>(
    from input: S
  ) -> (decoded: Base64UnsignedInteger, indexAfter: S.Index)? {
  ...
  public static func decode<S: Sequence<UInt8>>(
    from stream: S
  ) -> (decoded: Base64UnsignedInteger, readCount: Int)? {
    ...
    if a0.rawValue < 51 {
      return (decoded: Base64UnsignedInteger(a0.rawValue), readCount: 1)
    }
    ...
    if a0.rawValue == 51 {
      ...
      return (decoded: Base64UnsignedInteger(n), readCount: 2)
    }
    ...
    if a0.rawValue == 52 {
      ...
      return (decoded: Base64UnsignedInteger(n), readCount: 3)
    }
    ...
    return (decoded: Base64UnsignedInteger(n), readCount: 1 + digitCount)
  }
